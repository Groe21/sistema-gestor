...
include_once(__DIR__ . '/models/estudiantes/cantidad_estudiantes.php');
include_once(__DIR__ . '/models/escuela/mostrar_paralelos.php');
$pdo = conectarBaseDeDatos();
$cantidadEstudiantes = new CantidadEstudiantes($pdo);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <?php $cantidadEstudiantes->mostrarCardEstudiantes(); ?>

                    <?php $mostrarParalelos->mostrarCardCursos(); ?>
