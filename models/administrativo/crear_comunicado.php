    ...
    if ($imagen['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($imagen['tmp_name'], $rutaDestino)) {
            try {
                ...
                $sql = "INSERT INTO comunicados (titulo, contenido, imagen) VALUES (:titulo, :contenido, :imagen)";
                ...
                echo '<div class="alert alert-danger" role="alert">Ocurrió un error al crear el comunicado: ' . htmlspecialchars($e->getMessage()) . '</div>';
            }
        } else {
